...
public class HistoryServiceJpa extends ProjectServiceJpa implements
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getCurrentReleaseInfoForRefset(java.lang.Long)
   */
  @Override
  public ReleaseInfo getCurrentReleaseInfoForRefset(Long refsetId) throws Exception {
    ...
    List<ReleaseInfo> results = getReleaseHistoryForRefset(refsetId).getObjects();
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getCurrentReleaseInfoForTranslation(java.lang.Long)
   */
  @Override
  public ReleaseInfo getCurrentReleaseInfoForTranslation(Long translationId) throws Exception {
    Logger.getLogger(getClass()).debug(
        "History Service - get current release info for translation" + translationId);
    List<ReleaseInfo> results = getReleaseHistoryForTranslation(translationId).getObjects();
    // get max release that is published and not planned
    for (int i = results.size() - 1; i >= 0; i--) {
      if (results.get(i).isPublished() && !results.get(i).isPlanned()
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getPreviousReleaseInfoForRefset(java.lang.Long)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getPreviousReleaseInfoForTranslation(java.lang.Long)
   */
  @Override
  public ReleaseInfo getPreviousReleaseInfoForTranslation(Long translationId) throws Exception {
    Logger.getLogger(getClass()).debug(
        "History Service - get previous release info for translation" + translationId);
    List<ReleaseInfo> results = getReleaseHistoryForTranslation(translationId).getObjects();
    // get one before the max release that is published
    for (int i = results.size() - 1; i >= 0; i--) {
      if (results.get(i).isPublished() && !results.get(i).isPlanned()
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getPlannedReleaseInfoForRefset(java.lang.Long)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getPlannedReleaseInfoForTranslation(java.lang.Long)
   */
  @Override
  public ReleaseInfo getPlannedReleaseInfoForTranslation(Long translationId) throws Exception {
    Logger.getLogger(getClass()).debug(
        "History Service - get planned release info for translation" + translationId);
    List<ReleaseInfo> results = getReleaseHistoryForTranslation(translationId).getObjects();
    // get one before the max release that is published
    for (int i = results.size() - 1; i >= 0; i--) {
      if (!results.get(i).isPublished() && results.get(i).isPlanned()
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getReleaseHistoryForRefset(java.lang.Long)
   */
  @Override
  public ReleaseInfoList getReleaseHistoryForRefset(Long refsetId) throws Exception {
    ...
    javax.persistence.Query query =
        manager
            .createQuery("select a from ReleaseInfoJpa a, " +
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getReleaseHistoryForTranslation(java.lang.Long)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#addReleaseInfo(org.ihtsdo.otf.refset.ReleaseInfo)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#removeReleaseInfo(java.lang.Long)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#updateReleaseInfo(org.ihtsdo.otf.refset.ReleaseInfo)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getRefsetRevision(java.lang.Long, java.util.Date)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#getTranslationRevision(java.lang.Long, java.util.Date)
   */
  @Override
  public Translation getTranslationRevision(Long translationId, Date date) throws Exception {
    Logger.getLogger(getClass()).debug(
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.refset.services.HistoryService#findConceptsForTranslationRevision(java.lang.Long, java.util.Date, org.ihtsdo.otf.refset.helpers.PfsParameter)
   */
  @Override
