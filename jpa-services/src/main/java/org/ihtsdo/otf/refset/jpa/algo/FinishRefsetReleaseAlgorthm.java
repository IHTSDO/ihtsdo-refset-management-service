...
/**
 * Implementation of an algorithm to finish a release process for a refset.
 * 
 * <pre>
 ...
 */
public class FinishRefsetReleaseAlgorthm extends RootServiceJpa implements
    Algorithm {
  ...
  /**
   * Instantiates an empty {@link FinishRefsetReleaseAlgorthm}.
   * @throws Exception if anything goes wrong
   */
  public FinishRefsetReleaseAlgorthm() throws Exception {
    super();
  }
