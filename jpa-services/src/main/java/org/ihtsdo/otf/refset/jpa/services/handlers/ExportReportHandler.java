...
public class ExportReportHandler {
   ...
   */
  public InputStream exportReport(MemberDiffReport report, RefsetServiceJpa refsetService, 
    String migrationTerminology, String migrationVersion, Map<String, String> headers,
  ...
  /**
    ...
    private void handleExportReport(MemberDiffReport report, Workbook wb) throws Exception {
        Logger.getLogger(getClass()).info("Exporting report " +  "..."); // TODO: provide report name
        ...
        try {
            ...
            cell.setCellValue(createHelper.createRichTextString("New Members").toString());
            ...
            cell = row.createCell(cellnum);
            cell.setCellStyle(style);
            cell.setCellValue(createHelper.createRichTextString("Old Members").toString());
            ...
            for (ConceptRefsetMember member : report.getOldRegularMembers()) {
              ...
              /**if (!member.isConceptActive()
                ...
                for (Concept c : conceptList.getObjects()) {
                  appendReplacementConceptInfo(member, c, wb, sheet, rownum++, cell.getCellStyle());
                }
              }*/
            ...
            if (report.getNewRefset().getType() == Type.INTENSIONAL) {
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Valid Inclusions").toString());
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Valid Exclusions").toString());
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Migrated Inclusions").toString());
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Migrated Exclusions").toString());
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Invalid Inclusions").toString());
              ...
              cell = row.createCell(cellnum);
              cell.setCellStyle(style);
              cell.setCellValue(createHelper.createRichTextString("Invalid Exclusions").toString());
            ...
            cell = row.createCell(cellnum);
            cell.setCellStyle(style);
            cell.setCellValue(createHelper.createRichTextString("Inactive Concepts with their suggested Replacement Concepts").toString());
              ...
              if (!member.isConceptActive()) {
                ...
                for (Concept c : conceptList.getObjects()) {
                      if (!replacementsFound) {
                        makeReplacementConceptHeaderHelper(wb, sheet, rownum++, cell.getCellStyle());
                      }
                      appendReplacementConceptInfo(member, c, wb, sheet, rownum++, cell.getCellStyle());
            ...
            cell = row.createCell(cellnum);
            cell.setCellStyle(style);
            cell.setCellValue(createHelper.createRichTextString("Members in Common").toString());
    ...
    private void appendReplacementConceptInfo(
      ConceptRefsetMember member, Concept c, Workbook wb,
      Sheet sheet, int rownum, CellStyle style) throws Exception {
      ...
      makeReplacementConceptHelper(member, c, reasonConcept, wb,
          sheet, rownum, style);
  ...
  private void makeMemberRowHelper(ConceptRefsetMember member, Workbook wb,
    ...
    cell.setCellValue(createHelper
        .createRichTextString(member.getEffectiveTime() != null ? member.getEffectiveTime().toString() : ""));
  ...
  private void makeReplacementConceptHelper(ConceptRefsetMember member, Concept c, Concept reasonConcept, Workbook wb,
    Sheet sheet, int rownum, CellStyle style) {
    CreationHelper createHelper = wb.getCreationHelper();
    ...
    cell.setCellStyle(style);
    cell.setCellValue(
        createHelper.createRichTextString(member.getConceptId()));

    // Inactive Concept FSN
    cell = row.createCell(cellnum++);
    cell.setCellStyle(style);
    cell.setCellValue(createHelper
        .createRichTextString(member.getConceptName()));
    ...
    cell.setCellStyle(style);
    cell.setCellValue(createHelper
        .createRichTextString(c.getName()));

  }

  private void makeReplacementConceptHeaderHelper(Workbook wb, Sheet sheet, int rownum,
    CellStyle style) {
    CreationHelper createHelper = wb.getCreationHelper();
    ...
    cell = row.createCell(cellnum++);
    cell.setCellStyle(style);
    cell.setCellValue(createHelper.createRichTextString("Inactive Concept FSN"));
    ...
    cell = row.createCell(cellnum++);
    cell.setCellStyle(style);
    cell.setCellValue(createHelper.createRichTextString("Suggested Replacement ConceptID(s)"));

    // Suggested Replacement FSN(s)
    cell = row.createCell(cellnum++);
    cell.setCellStyle(style);
    cell.setCellValue(createHelper.createRichTextString("Suggested Replacement FSN(s)"));
