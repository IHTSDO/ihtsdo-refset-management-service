...
/**
 * Implementation of an algorithm to finish a release process for a translation.
 * 
 * <pre>
 * 1. Marks the corresponding release info as published.
 * 2. Updates workflow status of the translation to "PUBLISHED"
 * </pre>
 * 
 * This process is capable of generating notifications, warnings, or errors via
 * a {@link ValidationResult}
 */
public class FinishTranslationReleaseAlgorthm extends RootServiceJpa implements
    Algorithm {
  ...
  /**
   * Instantiates an empty {@link FinishTranslationReleaseAlgorthm}.
   * @throws Exception if anything goes wrong
   */
  public FinishTranslationReleaseAlgorthm() throws Exception {
    super();
  }
