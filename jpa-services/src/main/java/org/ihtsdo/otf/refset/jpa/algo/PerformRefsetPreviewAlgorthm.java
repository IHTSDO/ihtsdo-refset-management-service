 ...
 */
public class PerformRefsetPreviewAlgorthm extends RootServiceJpa implements
    Algorithm {
  ...
  /**
   * Instantiates an empty {@link PerformRefsetPreviewAlgorthm}.
   * @throws Exception if anything goes wrong
   */
  public PerformRefsetPreviewAlgorthm() throws Exception {
    super();
  }
