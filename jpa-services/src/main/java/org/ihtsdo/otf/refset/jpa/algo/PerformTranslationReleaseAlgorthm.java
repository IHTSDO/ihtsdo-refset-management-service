 ...
 */
public class PerformTranslationReleaseAlgorthm extends RootServiceJpa implements
    Algorithm {
  ...
  /**
   * Instantiates an empty {@link PerformTranslationReleaseAlgorthm}.
   * @throws Exception if anything goes wrong
   */
  public PerformTranslationReleaseAlgorthm() throws Exception {
    super();
  }
