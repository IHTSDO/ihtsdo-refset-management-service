...
/**
 * Unit testing for {@link AttributeValueConceptRefSetMemberJpa}.
 */
public class ModelUnit014Test {

  /** The model object to test. */
  private AttributeValueConceptRefSetMemberJpa object;
  ...
  @Before
  public void setup() {
    object = new AttributeValueConceptRefSetMemberJpa();
    // Set up some objects
    c1 = new ConceptJpa();
    c1.setId(1L);
   ...
   */
  @Test
  public void testModelGetSet014() throws Exception {
   ...
   */
  @Test
  public void testModelEqualsHashcode014() throws Exception {
    Logger.getLogger(getClass()).debug("TEST testModelEqualsHashcode014");
   ...
   */
  @Test
  public void testModelCopy014() throws Exception {
    ...
    assertTrue(tester
        .testCopyConstructor(AttributeValueConceptRefSetMember.class));
  }
   ...
   */
  @Test
  public void testModelXmlSerialization014() throws Exception {
    Logger.getLogger(getClass()).debug("TEST testModelXmlTransient014");
   ...
   */
  @Test
  public void testModelXmlTransient014() throws Exception {
    Logger.getLogger(getClass()).debug("TEST testModelXmlTransient014");
    Concept c = new ConceptJpa();
    c.setId(1L);
    c.setTerminologyId("1");
    ...
    member.setConcept(c);
    c.addAttributeValueRefSetMember(member);
   ...
   */
  @Test
  public void testModelNotNullField014() throws Exception {
    Logger.getLogger(getClass()).debug("TEST testModelNotNullField014");
