...
public class DefaultSpellingCorrectionHandlerTest extends JpaSupport {
  ...
  /**
   * Testing adding multiple terms into list then showing term not in suggestion
   * list.
   *
   * @throws Exception the exception
   */
  ...
  /**
   * Testing clearing the index of all terms as searching afterwards yields zero
   * results.
   *
   * @throws Exception the exception
   */
  ...
  /**
   * Testing clearing an index and recreating content with same handler behaves
   * as before clearing it.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void testGetAllEntriesAsStream() throws Exception {
    ...
    InputStream entriesStream = handler.getEntriesAsStream();
    SpellingCorrectionHandler handler2 = new DefaultSpellingCorrectionHandler();
    handler2.setTranslationId(new Long(10));
    handler2.updateDictionaryFromStream(entriesStream, false);
  ...
  public void testGetAllEntriesAsList() throws Exception {
    ...
    assertEquals(baseList, handler.getEntriesAsList());
