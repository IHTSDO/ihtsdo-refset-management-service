    ...
    function($rootScope, $compile, $timeout, $window, $sce, uiTinymceConfig) {
      ...
      return {
        ...
        link : function(scope, element, attrs, ctrls) {
          ...
          var ngModel = ctrls[0], form = ctrls[1] || null;

          var expression, options = {}, tinyInstance, updateView = function(editor) {
          ...
          // Wrapped in $timeout due to $tinymce:refresh implementation,
          // requires
