...
tsApp
  .directive(
    ...
    [
      ...
      'workflowService',
      'validationService',
      function($uibModal, utilService, projectService, refsetService,
          ...
          controller : [
            ...
            function($scope) {
              ...
              $scope.getConceptParents = function(concept) {
                ...
                projectService
                  .getConceptParents(
                    ...
                    $scope.data.version,
                    ($scope.data.translation ? $scope.data.translation.id
                      : null)).then(
                  // Success
                  function(data) {
              ...
              $scope.sortByDescriptionType = function(a, b) {
                ...
                return a = $scope.getDescriptionType(a) + latCodea, b = $scope
                  .getDescriptionType(b)
                  + latCodeb, (a > b) - (b > a);
              };
              ...
              $scope.getDescriptionType = function(description) {
                for (var i = 0; i < $scope.data.descriptionTypes.length; i++) {
                  ...
                  if (description.typeId == type.typeId
              ...
              $scope.getAllConcepts = function() {
                ...
                for (var i = 0; i < $scope.children.length; i++) {
                  concepts = concepts.concat($scope
                    .getAllConceptsHelper($scope.children[i]));
                }
                for (var i = 0; i < $scope.parents.length; i++) {
                  concepts = concepts.concat($scope
                    .getAllConceptsHelper($scope.parents[i]));
                }
                return concepts;
              };
              ...
              $scope.getAllConceptsHelper = function(tree) {
                ...
                if (tree.inner) {
                  for (var i = 0; i < tree.inner.length; i++) {
                    concepts = concepts.concat($scope
                      .getAllConceptsHelper(tree.inner[i]));
                  }
                }
                return concepts;
              };
              ...
              $scope.getMemberTypes = function() {
                console.debug("get member types", $scope.data.refset,
                  $scope.value);
                ...
                query = '(' + query + ')';
                refsetService
                  .findRefsetMembersForQuery($scope.data.refset.id, query, pfs)
                  .then(
                    // Success
                    function(data) {
              ...
              var AddModalCtrl = function($scope, $uibModalInstance, refset,
                member) {
                ...
                $scope.descendants = '<';
                $scope.includeClause = member.terminologyId + ' | '
                  + member.name + ' |';
                ...
                $scope.submitAdd = function(refset, concept, value) {
                  ...
                  // addRefsetMembersForExpression
                    ...
                    refsetService.addRefsetMembersForExpression(refset, value)
                      .then(
                      // Success - update refset
                      function(data) {
                        $uibModalInstance.close(refset);
              ...
              var RemoveModalCtrl = function($scope, $uibModalInstance, refset,
                member) {
                ...
                $scope.selfAndDescendants = '<<';
                $scope.descendants = '<';
                $scope.removeClause = member.conceptId + ' | '
                  + member.conceptName + ' |';
                ...
                $scope.submitRemove = function(refset, concept, value) {
                  ...
                  // removeRefsetMembersForExpression
                    ...
                    refsetService.removeRefsetMembersForExpression(refset,
                      value).then(
                  ...
                  // if intensional and clause undefined, call add exclusion
                    ...
                    refsetService.addRefsetExclusion(refset, member.conceptId,
                      false).then(
